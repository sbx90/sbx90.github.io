...
function initCanvas(canvas: HTMLCanvasElement) {
  ...
  const interpolate = (c1: any, c2: any, f: any) => {
    return {
  ...
  const makeRandomPalette = () => {
    ...
    const c1 = { r: 14, g: 18, b: 107 };
    const c2 = { r: 31, g: 43, b: 123 };
    const c3 = { r: 21, g: 25, b: 124 };
    const c4 = { r: 69, g: 113, b: 178 };
    // const c5 = { r: 92, g: 156, b: 212 };
    // const c4 = randomColor();
    const c5 = randomColor();
  ...
  const linearGradient = (c1: any, c2: any) => {
    const g = [];
...
const fuildAnimatedDisplay: React.FC = () => {
...
export default fuildAnimatedDisplay;
